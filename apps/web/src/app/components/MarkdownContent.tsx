        ...
        <ReactMarkdown
          ...
          components={{
            code({
              ...
              // Detect inline code by checking if content contains a newline.
              // react-markdown v9+ removed the `inline` prop; use content heuristic instead.
              ...
              return !isInline && match ? (
                ...
                <code className="bg-surface rounded-sm px-1 py-0.5 font-mono text-[0.9em]" {...props}>
                  {children}
                </code>
              );
            },
            ...
            a({ href, children }: { href?: string; children?: React.ReactNode }) {
              // Sanitise href: only allow http/https to prevent javascript: URI XSS
